...
public class HTTPHeadRequest extends HTTPRequest{
    public HTTPHeadRequest(Socket client, boolean isScript, String[] uri, String[] requestMainHeader, HTTPDConf config, MimeTypes mimeTypes) {
...
//             Create the 200 HTTPResponse object
            ...
            // Because it is a head request, do not need to add body
    ...
    public String getMainRequestHeader() {
        return "HEAD " + this.getRequestedURI() + " " + this.getHttpVersion();
    }
}
